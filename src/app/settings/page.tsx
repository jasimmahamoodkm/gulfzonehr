  ...
  return (
    <Layout>
      <div className="space-y-6">
        ...
        {activeTab === 'profile' && (
          <div className="space-y-6">
            <Card header={<h2 className="text-lg font-semibold">Theme</h2>}>
              <p className="text-sm text-muted-foreground mb-6">
                Applies to every page on this device. Your choice is kept after logout and restored when you sign in again.
              </p>
              <ThemePicker />
            </Card>
            ...
            <Card header={<h2 className="text-lg font-semibold">Personal Information</h2>}>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-2 border border-input rounded-lg focus:outline-none focus:ring-2 focus:ring-ring bg-muted" disabled>
                    <option>{user?.role || 'User'}</option>
                  </select>
                </div>
                <p className="text-sm text-muted-foreground">Profile information is managed by administrators.</p>
              </div>
            </Card>
            ...
            <Card header={<h2 className="text-lg font-semibold">Organization Settings</h2>}>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-2 border border-input rounded-lg focus:outline-none focus:ring-2 focus:ring-ring" disabled>
          ...
          <div className="space-y-6">
                ...
                <form onSubmit={handleSubmit(onPasswordSubmit)} className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-4">
                    <button
                      ...
                      className="px-4 py-2 bg-primary hover:bg-primary/90 disabled:bg-muted disabled:text-muted-foreground text-primary-foreground rounded-lg font-medium transition"
                    >
                    ...
                    <button
                      type="button"
                      onClick={() => reset()}
                      className="px-4 py-2 bg-secondary hover:bg-secondary/80 text-secondary-foreground rounded-lg font-medium transition"
                    >
                      Cancel
                    </button>
                  </div>
            ...
            <Card header={<h2 className="text-lg font-semibold">Two-Factor Authentication</h2>}>
              <div className="space-y-4">
                ...
                <button className="px-4 py-2 bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg font-medium transition">
                  Enable 2FA
                </button>
              </div>
            </Card>
            ...
            {user?.roles?.some(role => role.role_name === 'Employee') ? (
              <>
                <Card header={<h2 className="text-lg font-semibold">Email Notifications</h2>}>
                  <div className="space-y-4">
                    <p className="text-sm text-muted-foreground mb-4">You can receive notifications for the following alerts:</p>
                    {[
                      ...
                      <label key={notif.name} className="flex items-start gap-3 p-3 bg-muted rounded-lg cursor-pointer hover:bg-muted">
                    ...
                    <div className="flex gap-3 pt-4">
                      ...
                      <button className="px-4 py-2 bg-secondary hover:bg-secondary/80 text-secondary-foreground rounded-lg font-medium transition">
                        Reset to Default
                      </button>
                    </div>
                  </div>
                ...
                <Card header={<h2 className="text-lg font-semibold">SMS Notifications</h2>}>
                  <div className="space-y-4">
                    <p className="text-muted-foreground">Receive SMS alerts for critical notifications.</p>
